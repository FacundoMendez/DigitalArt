...
const canvas = document.querySelector('.container3__cardMovile1')

const scene = new THREE.Scene()


const texture = new THREE.TextureLoader().load( "./jsm/jsThree/img/8.png" );
...
pointLight1.position.set(1,4,1.5)
scene.add(pointLight1)

const pointLight2 = new THREE.PointLight(0x777777, 2.5)
pointLight2.position.set(-2.5,-2,2)
scene.add(pointLight2)

const pointLight3 = new THREE.PointLight(0x777777, 2.5)
pointLight3.position.set(0.5,-1,2)
scene.add(pointLight3)

const pointLight4 = new THREE.PointLight(0x777777, 0.5)
pointLight4.position.y = 1
pointLight4.position.x = 0
pointLight4.position.z = 6
