...
const canvas = document.querySelector('.container3__card-webgl10')

const scene = new THREE.Scene()


const texture = new THREE.TextureLoader().load( "./img/collections/hercules/7.png" );
...
pointLight1.position.set(0,5,1.5)
