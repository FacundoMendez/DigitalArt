...
const canvas = document.querySelector('.container3__card-webgl7')

const scene = new THREE.Scene()


const texture = new THREE.TextureLoader().load( "./img/collections/losIncreibles/8.png" );
...
const pointLight2 = new THREE.PointLight(0x777777, 0.5)
pointLight2.position.set(2.5,0,3)
scene.add(pointLight2)

const pointLight3 = new THREE.PointLight(0x777777, 1.5)
